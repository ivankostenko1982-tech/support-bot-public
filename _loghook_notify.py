# -*- coding: utf-8 -*-
"""
_loghook_notify.py — обработчик логов "TESTPURGE: deleted ..." с отправкой ЛС админу (русский формат).
"""
...
class _OnceNotifyHandler(logging.Handler):
    """Хендлер: отправляем ЛС один раз на пару chat:user до перезапуска."""
    _sent: set[str] = set()
